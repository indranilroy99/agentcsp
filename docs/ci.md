...
Use that summary to explain whether a gate failed because of severity thresholds, new findings, expired suppressions, or diagnostics. The summary does not include raw evidence snippets or secret values.
