...
- vulnerable fixture coverage for source-defined MCP tools that combine external writes, PII/customer data, credential-like inputs, open-world arguments, Python signature/Pydantic extraction, and destructive filesystem authority
