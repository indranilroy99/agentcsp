...
- Continue expanding source-defined tool parsing beyond config files, including more MCP SDK registration shapes, broader Python/Pydantic schema extraction, richer framework-specific adapters, broader guardrail/approval-policy SDK coverage, and additional agent framework languages.
