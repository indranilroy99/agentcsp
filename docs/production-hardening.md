...
- public model-gateway metadata for anonymous/public exposure, disabled authentication, request logging, redaction posture, tool-calling posture, sensitive context capture, and approval boundaries without emitting gateway URLs, model names, tool names, data labels, or token placeholders
