...
assertEqual(vulnerable.manifest.findings.length, 242, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 242, "vulnerable findings.json count");
