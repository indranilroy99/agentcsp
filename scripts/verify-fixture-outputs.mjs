...
assertEqual(vulnerable.manifest.findings.length, 139, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 139, "vulnerable findings.json count");
