...
assertEqual(vulnerable.manifest.findings.length, 569, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 569, "vulnerable findings.json count");
