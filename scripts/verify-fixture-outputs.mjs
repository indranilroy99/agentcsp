...
assertEqual(vulnerable.manifest.findings.length, 150, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 150, "vulnerable findings.json count");
