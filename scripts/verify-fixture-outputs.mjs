...
assertEqual(vulnerable.manifest.findings.length, 1287, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1287, "vulnerable findings.json count");
