...
assertEqual(vulnerable.manifest.findings.length, 557, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 557, "vulnerable findings.json count");
