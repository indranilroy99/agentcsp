...
assertEqual(vulnerable.manifest.findings.length, 86, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 86, "vulnerable findings.json count");
