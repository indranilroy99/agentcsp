...
assertEqual(vulnerable.manifest.findings.length, 1225, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1225, "vulnerable findings.json count");
