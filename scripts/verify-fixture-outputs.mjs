...
assertEqual(vulnerable.manifest.findings.length, 440, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 440, "vulnerable findings.json count");
