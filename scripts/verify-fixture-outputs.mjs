...
assertEqual(vulnerable.manifest.findings.length, 318, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 318, "vulnerable findings.json count");
