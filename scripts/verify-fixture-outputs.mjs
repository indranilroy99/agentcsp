...
assertEqual(vulnerable.manifest.findings.length, 182, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 182, "vulnerable findings.json count");
