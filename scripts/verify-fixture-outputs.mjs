...
assertEqual(vulnerable.manifest.findings.length, 218, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 218, "vulnerable findings.json count");
