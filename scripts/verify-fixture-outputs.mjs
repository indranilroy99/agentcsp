...
assertEqual(vulnerable.manifest.findings.length, 1115, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1115, "vulnerable findings.json count");
