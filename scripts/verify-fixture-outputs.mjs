...
assertEqual(vulnerable.manifest.findings.length, 900, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 900, "vulnerable findings.json count");
