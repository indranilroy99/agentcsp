...
assertEqual(vulnerable.manifest.findings.length, 174, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 174, "vulnerable findings.json count");
