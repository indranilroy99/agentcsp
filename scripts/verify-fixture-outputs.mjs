...
assertEqual(vulnerable.manifest.findings.length, 196, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 196, "vulnerable findings.json count");
