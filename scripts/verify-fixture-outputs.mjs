...
assertEqual(vulnerable.manifest.findings.length, 306, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 306, "vulnerable findings.json count");
