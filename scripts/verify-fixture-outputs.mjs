...
assertEqual(vulnerable.manifest.findings.length, 1055, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1055, "vulnerable findings.json count");
