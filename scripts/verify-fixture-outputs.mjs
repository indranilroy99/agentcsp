...
assertEqual(vulnerable.manifest.findings.length, 163, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 163, "vulnerable findings.json count");
