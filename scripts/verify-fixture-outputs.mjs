...
assertEqual(vulnerable.manifest.findings.length, 626, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 626, "vulnerable findings.json count");
