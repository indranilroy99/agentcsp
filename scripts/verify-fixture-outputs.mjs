...
assertEqual(vulnerable.manifest.findings.length, 244, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 244, "vulnerable findings.json count");
