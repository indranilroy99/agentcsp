...
assertEqual(vulnerable.manifest.findings.length, 364, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 364, "vulnerable findings.json count");
