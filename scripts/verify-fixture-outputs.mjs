...
assertEqual(vulnerable.manifest.findings.length, 199, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 199, "vulnerable findings.json count");
