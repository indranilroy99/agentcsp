...
assertEqual(vulnerable.manifest.findings.length, 1177, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1177, "vulnerable findings.json count");
