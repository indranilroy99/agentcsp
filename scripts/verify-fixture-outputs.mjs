...
assertEqual(vulnerable.manifest.findings.length, 185, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 185, "vulnerable findings.json count");
