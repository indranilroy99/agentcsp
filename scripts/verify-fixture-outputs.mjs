...
assertEqual(vulnerable.manifest.findings.length, 937, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 937, "vulnerable findings.json count");
