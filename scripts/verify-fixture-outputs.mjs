...
assertEqual(vulnerable.manifest.findings.length, 1301, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1301, "vulnerable findings.json count");
