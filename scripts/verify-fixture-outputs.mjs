...
assertEqual(vulnerable.manifest.findings.length, 535, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 535, "vulnerable findings.json count");
