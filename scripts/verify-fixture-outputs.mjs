...
assertEqual(vulnerable.manifest.findings.length, 220, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 220, "vulnerable findings.json count");
