...
assertEqual(vulnerable.manifest.findings.length, 338, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 338, "vulnerable findings.json count");
