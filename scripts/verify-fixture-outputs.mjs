...
assertEqual(vulnerable.manifest.findings.length, 666, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 666, "vulnerable findings.json count");
