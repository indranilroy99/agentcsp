...
assertEqual(vulnerable.manifest.findings.length, 85, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 85, "vulnerable findings.json count");
