...
assertEqual(vulnerable.manifest.findings.length, 235, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 235, "vulnerable findings.json count");
