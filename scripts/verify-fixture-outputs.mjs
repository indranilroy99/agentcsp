...
assertEqual(vulnerable.manifest.findings.length, 322, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 322, "vulnerable findings.json count");
