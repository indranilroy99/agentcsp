...
assertEqual(vulnerable.manifest.findings.length, 324, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 324, "vulnerable findings.json count");
