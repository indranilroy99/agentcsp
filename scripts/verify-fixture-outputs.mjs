...
assertEqual(vulnerable.manifest.findings.length, 748, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 748, "vulnerable findings.json count");
