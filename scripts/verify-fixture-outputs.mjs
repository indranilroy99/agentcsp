...
assertEqual(vulnerable.manifest.findings.length, 507, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 507, "vulnerable findings.json count");
