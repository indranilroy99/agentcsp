...
assertEqual(vulnerable.manifest.findings.length, 344, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 344, "vulnerable findings.json count");
