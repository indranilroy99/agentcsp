...
assertEqual(vulnerable.manifest.findings.length, 308, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 308, "vulnerable findings.json count");
