...
assertEqual(vulnerable.manifest.findings.length, 356, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 356, "vulnerable findings.json count");
