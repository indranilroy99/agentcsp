...
assertEqual(vulnerable.manifest.findings.length, 71, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 71, "vulnerable findings.json count");
