...
assertEqual(vulnerable.manifest.findings.length, 326, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 326, "vulnerable findings.json count");
