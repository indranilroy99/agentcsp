...
assertEqual(vulnerable.manifest.findings.length, 585, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 585, "vulnerable findings.json count");
