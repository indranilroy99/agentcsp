...
assertEqual(vulnerable.manifest.findings.length, 102, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 102, "vulnerable findings.json count");
