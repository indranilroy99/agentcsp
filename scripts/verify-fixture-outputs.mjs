...
assertEqual(vulnerable.manifest.findings.length, 891, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 891, "vulnerable findings.json count");
