...
assertEqual(vulnerable.manifest.findings.length, 239, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 239, "vulnerable findings.json count");
