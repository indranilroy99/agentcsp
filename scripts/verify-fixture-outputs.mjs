...
assertEqual(vulnerable.manifest.findings.length, 1217, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1217, "vulnerable findings.json count");
