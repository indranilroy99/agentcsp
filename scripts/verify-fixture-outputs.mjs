...
assertEqual(vulnerable.manifest.findings.length, 1395, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1395, "vulnerable findings.json count");
