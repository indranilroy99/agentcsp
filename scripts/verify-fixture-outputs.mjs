...
assertEqual(vulnerable.manifest.findings.length, 368, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 368, "vulnerable findings.json count");
