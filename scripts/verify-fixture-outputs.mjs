...
assertEqual(vulnerable.manifest.findings.length, 464, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 464, "vulnerable findings.json count");
