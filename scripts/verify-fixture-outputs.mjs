...
assertEqual(vulnerable.manifest.findings.length, 204, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 204, "vulnerable findings.json count");
