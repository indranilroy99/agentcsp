...
assertEqual(vulnerable.manifest.findings.length, 312, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 312, "vulnerable findings.json count");
