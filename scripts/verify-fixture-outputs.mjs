...
assertEqual(vulnerable.manifest.findings.length, 342, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 342, "vulnerable findings.json count");
