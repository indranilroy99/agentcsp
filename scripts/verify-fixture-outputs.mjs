...
assertEqual(vulnerable.manifest.findings.length, 1383, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1383, "vulnerable findings.json count");
