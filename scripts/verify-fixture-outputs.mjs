...
assertEqual(vulnerable.manifest.findings.length, 212, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 212, "vulnerable findings.json count");
