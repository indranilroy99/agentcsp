...
assertEqual(vulnerable.manifest.findings.length, 724, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 724, "vulnerable findings.json count");
