...
assertEqual(vulnerable.manifest.findings.length, 690, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 690, "vulnerable findings.json count");
