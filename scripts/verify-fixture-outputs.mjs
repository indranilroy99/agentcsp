...
assertEqual(vulnerable.manifest.findings.length, 1063, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1063, "vulnerable findings.json count");
