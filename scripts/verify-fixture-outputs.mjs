...
assertEqual(vulnerable.manifest.findings.length, 217, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 217, "vulnerable findings.json count");
