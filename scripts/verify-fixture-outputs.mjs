...
assertEqual(vulnerable.manifest.findings.length, 328, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 328, "vulnerable findings.json count");
