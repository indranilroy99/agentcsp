...
assertEqual(vulnerable.manifest.findings.length, 336, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 336, "vulnerable findings.json count");
