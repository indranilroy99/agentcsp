...
assertEqual(vulnerable.manifest.findings.length, 1245, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1245, "vulnerable findings.json count");
