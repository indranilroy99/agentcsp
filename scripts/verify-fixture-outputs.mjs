...
assertEqual(vulnerable.manifest.findings.length, 517, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 517, "vulnerable findings.json count");
