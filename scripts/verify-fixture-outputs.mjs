...
assertEqual(vulnerable.manifest.findings.length, 186, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 186, "vulnerable findings.json count");
