...
assertEqual(vulnerable.manifest.findings.length, 184, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 184, "vulnerable findings.json count");
