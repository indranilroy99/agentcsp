...
assertEqual(vulnerable.manifest.findings.length, 632, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 632, "vulnerable findings.json count");
