...
assertEqual(vulnerable.manifest.findings.length, 1145, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1145, "vulnerable findings.json count");
