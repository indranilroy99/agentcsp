...
assertEqual(vulnerable.manifest.findings.length, 211, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 211, "vulnerable findings.json count");
