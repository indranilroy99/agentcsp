...
assertEqual(vulnerable.manifest.findings.length, 215, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 215, "vulnerable findings.json count");
