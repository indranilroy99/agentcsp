...
assertEqual(vulnerable.manifest.findings.length, 1391, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1391, "vulnerable findings.json count");
