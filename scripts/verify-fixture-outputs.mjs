...
assertEqual(vulnerable.manifest.findings.length, 221, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 221, "vulnerable findings.json count");
