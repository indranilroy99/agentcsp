...
assertEqual(vulnerable.manifest.findings.length, 1047, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1047, "vulnerable findings.json count");
