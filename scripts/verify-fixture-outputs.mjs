...
assertEqual(vulnerable.manifest.findings.length, 230, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 230, "vulnerable findings.json count");
