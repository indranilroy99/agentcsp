...
assertEqual(vulnerable.manifest.findings.length, 414, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 414, "vulnerable findings.json count");
