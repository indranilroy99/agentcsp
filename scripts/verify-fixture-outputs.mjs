...
assertEqual(vulnerable.manifest.findings.length, 1103, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1103, "vulnerable findings.json count");
