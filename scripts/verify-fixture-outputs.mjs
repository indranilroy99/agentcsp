...
assertEqual(vulnerable.manifest.findings.length, 194, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 194, "vulnerable findings.json count");
