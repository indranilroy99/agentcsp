...
assertEqual(vulnerable.manifest.findings.length, 202, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 202, "vulnerable findings.json count");
