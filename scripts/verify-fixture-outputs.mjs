...
assertEqual(vulnerable.manifest.findings.length, 267, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 267, "vulnerable findings.json count");
