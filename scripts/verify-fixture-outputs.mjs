...
assertEqual(vulnerable.manifest.findings.length, 198, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 198, "vulnerable findings.json count");
