...
assertEqual(vulnerable.manifest.findings.length, 716, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 716, "vulnerable findings.json count");
