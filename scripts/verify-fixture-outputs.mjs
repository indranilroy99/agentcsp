...
assertEqual(vulnerable.manifest.findings.length, 69, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 69, "vulnerable findings.json count");
