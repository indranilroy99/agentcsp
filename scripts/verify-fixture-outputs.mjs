...
assertEqual(vulnerable.manifest.findings.length, 156, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 156, "vulnerable findings.json count");
