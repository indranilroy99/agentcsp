...
assertEqual(vulnerable.manifest.findings.length, 187, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 187, "vulnerable findings.json count");
