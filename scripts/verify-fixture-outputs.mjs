...
assertEqual(vulnerable.manifest.findings.length, 207, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 207, "vulnerable findings.json count");
