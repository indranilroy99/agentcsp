...
assertEqual(vulnerable.manifest.findings.length, 310, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 310, "vulnerable findings.json count");
