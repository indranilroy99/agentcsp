...
assertEqual(vulnerable.manifest.findings.length, 358, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 358, "vulnerable findings.json count");
