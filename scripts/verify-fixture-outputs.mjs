...
assertEqual(vulnerable.manifest.findings.length, 354, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 354, "vulnerable findings.json count");
