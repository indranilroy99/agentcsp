...
assertEqual(vulnerable.manifest.findings.length, 1381, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1381, "vulnerable findings.json count");
