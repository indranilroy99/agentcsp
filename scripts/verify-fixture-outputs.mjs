...
assertEqual(vulnerable.manifest.findings.length, 615, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 615, "vulnerable findings.json count");
