...
assertEqual(vulnerable.manifest.findings.length, 678, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 678, "vulnerable findings.json count");
