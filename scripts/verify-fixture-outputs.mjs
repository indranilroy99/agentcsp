...
assertEqual(vulnerable.manifest.findings.length, 476, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 476, "vulnerable findings.json count");
