...
assertEqual(vulnerable.manifest.findings.length, 208, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 208, "vulnerable findings.json count");
