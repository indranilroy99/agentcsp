...
assertEqual(vulnerable.manifest.findings.length, 197, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 197, "vulnerable findings.json count");
