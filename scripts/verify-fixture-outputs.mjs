...
assertEqual(vulnerable.manifest.findings.length, 234, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 234, "vulnerable findings.json count");
