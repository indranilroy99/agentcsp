...
assertEqual(vulnerable.manifest.findings.length, 1111, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1111, "vulnerable findings.json count");
