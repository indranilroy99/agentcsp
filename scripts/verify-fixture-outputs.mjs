...
assertEqual(vulnerable.manifest.findings.length, 140, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 140, "vulnerable findings.json count");
