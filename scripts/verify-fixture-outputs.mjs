...
assertEqual(vulnerable.manifest.findings.length, 223, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 223, "vulnerable findings.json count");
