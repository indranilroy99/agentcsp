...
assertEqual(vulnerable.manifest.findings.length, 1337, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1337, "vulnerable findings.json count");
