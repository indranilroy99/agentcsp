...
assertEqual(vulnerable.manifest.findings.length, 193, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 193, "vulnerable findings.json count");
