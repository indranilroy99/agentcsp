...
assertEqual(vulnerable.manifest.findings.length, 370, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 370, "vulnerable findings.json count");
