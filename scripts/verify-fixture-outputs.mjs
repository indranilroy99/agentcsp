...
assertEqual(vulnerable.manifest.findings.length, 1387, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1387, "vulnerable findings.json count");
