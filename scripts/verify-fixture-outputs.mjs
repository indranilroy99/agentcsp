...
assertEqual(vulnerable.manifest.findings.length, 219, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 219, "vulnerable findings.json count");
