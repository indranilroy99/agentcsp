...
assertEqual(vulnerable.manifest.findings.length, 531, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 531, "vulnerable findings.json count");
