...
assertEqual(vulnerable.manifest.findings.length, 191, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 191, "vulnerable findings.json count");
