...
assertEqual(vulnerable.manifest.findings.length, 589, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 589, "vulnerable findings.json count");
