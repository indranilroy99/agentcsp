...
assertEqual(vulnerable.manifest.findings.length, 575, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 575, "vulnerable findings.json count");
