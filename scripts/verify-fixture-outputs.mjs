...
assertEqual(vulnerable.manifest.findings.length, 742, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 742, "vulnerable findings.json count");
