...
assertEqual(vulnerable.manifest.findings.length, 1205, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1205, "vulnerable findings.json count");
