...
assertEqual(vulnerable.manifest.findings.length, 1161, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1161, "vulnerable findings.json count");
