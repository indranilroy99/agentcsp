...
assertEqual(vulnerable.manifest.findings.length, 773, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 773, "vulnerable findings.json count");
