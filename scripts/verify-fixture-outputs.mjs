...
assertEqual(vulnerable.manifest.findings.length, 346, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 346, "vulnerable findings.json count");
