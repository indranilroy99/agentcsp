...
assertEqual(vulnerable.manifest.findings.length, 214, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 214, "vulnerable findings.json count");
