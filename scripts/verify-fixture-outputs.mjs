...
assertEqual(vulnerable.manifest.findings.length, 931, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 931, "vulnerable findings.json count");
