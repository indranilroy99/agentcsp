...
assertEqual(vulnerable.manifest.findings.length, 181, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 181, "vulnerable findings.json count");
