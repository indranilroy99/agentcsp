...
assertEqual(vulnerable.manifest.findings.length, 642, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 642, "vulnerable findings.json count");
