...
assertEqual(vulnerable.manifest.findings.length, 1125, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1125, "vulnerable findings.json count");
