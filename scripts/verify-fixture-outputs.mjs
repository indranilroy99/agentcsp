...
assertEqual(vulnerable.manifest.findings.length, 290, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 290, "vulnerable findings.json count");
