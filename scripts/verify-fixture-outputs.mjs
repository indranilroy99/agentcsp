...
assertEqual(vulnerable.manifest.findings.length, 213, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 213, "vulnerable findings.json count");
