...
assertEqual(vulnerable.manifest.findings.length, 141, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 141, "vulnerable findings.json count");
