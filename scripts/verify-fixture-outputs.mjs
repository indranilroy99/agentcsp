...
assertEqual(vulnerable.manifest.findings.length, 340, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 340, "vulnerable findings.json count");
