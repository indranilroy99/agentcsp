...
assertEqual(vulnerable.manifest.findings.length, 241, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 241, "vulnerable findings.json count");
