...
assertEqual(vulnerable.manifest.findings.length, 236, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 236, "vulnerable findings.json count");
