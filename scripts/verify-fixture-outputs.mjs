...
assertEqual(vulnerable.manifest.findings.length, 216, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 216, "vulnerable findings.json count");
