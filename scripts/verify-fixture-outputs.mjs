...
assertEqual(vulnerable.manifest.findings.length, 222, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 222, "vulnerable findings.json count");
