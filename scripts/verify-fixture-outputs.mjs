...
assertEqual(vulnerable.manifest.findings.length, 101, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 101, "vulnerable findings.json count");
