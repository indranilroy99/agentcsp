...
assertEqual(vulnerable.manifest.findings.length, 92, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 92, "vulnerable findings.json count");
