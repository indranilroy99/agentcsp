...
assertEqual(vulnerable.manifest.findings.length, 240, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 240, "vulnerable findings.json count");
