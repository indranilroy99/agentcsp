...
assertEqual(vulnerable.manifest.findings.length, 192, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 192, "vulnerable findings.json count");
