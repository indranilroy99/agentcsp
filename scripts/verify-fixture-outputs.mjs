...
assertEqual(vulnerable.manifest.findings.length, 302, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 302, "vulnerable findings.json count");
