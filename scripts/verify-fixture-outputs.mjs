...
assertEqual(vulnerable.manifest.findings.length, 158, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 158, "vulnerable findings.json count");
