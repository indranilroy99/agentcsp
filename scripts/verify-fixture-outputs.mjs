...
assertEqual(vulnerable.manifest.findings.length, 362, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 362, "vulnerable findings.json count");
