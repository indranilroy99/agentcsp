...
assertEqual(vulnerable.manifest.findings.length, 1147, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1147, "vulnerable findings.json count");
