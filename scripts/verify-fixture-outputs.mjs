...
assertEqual(vulnerable.manifest.findings.length, 352, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 352, "vulnerable findings.json count");
