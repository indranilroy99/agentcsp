...
assertEqual(vulnerable.manifest.findings.length, 1251, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1251, "vulnerable findings.json count");
