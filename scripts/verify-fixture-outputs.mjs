...
assertEqual(vulnerable.manifest.findings.length, 205, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 205, "vulnerable findings.json count");
