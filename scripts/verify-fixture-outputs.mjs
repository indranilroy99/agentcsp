...
assertEqual(vulnerable.manifest.findings.length, 360, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 360, "vulnerable findings.json count");
