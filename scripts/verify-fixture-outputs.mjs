...
assertEqual(vulnerable.manifest.findings.length, 1071, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1071, "vulnerable findings.json count");
