...
assertEqual(vulnerable.manifest.findings.length, 366, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 366, "vulnerable findings.json count");
