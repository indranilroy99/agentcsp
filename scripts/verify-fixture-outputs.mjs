...
assertEqual(vulnerable.manifest.findings.length, 271, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 271, "vulnerable findings.json count");
