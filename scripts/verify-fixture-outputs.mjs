...
assertEqual(vulnerable.manifest.findings.length, 190, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 190, "vulnerable findings.json count");
