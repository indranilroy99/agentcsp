...
assertEqual(vulnerable.manifest.findings.length, 136, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 136, "vulnerable findings.json count");
