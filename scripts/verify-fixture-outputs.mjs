...
assertEqual(vulnerable.manifest.findings.length, 188, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 188, "vulnerable findings.json count");
