...
assertEqual(vulnerable.manifest.findings.length, 567, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 567, "vulnerable findings.json count");
