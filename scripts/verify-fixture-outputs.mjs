...
assertEqual(vulnerable.manifest.findings.length, 178, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 178, "vulnerable findings.json count");
