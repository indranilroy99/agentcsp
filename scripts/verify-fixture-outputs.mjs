...
assertEqual(vulnerable.manifest.findings.length, 909, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 909, "vulnerable findings.json count");
