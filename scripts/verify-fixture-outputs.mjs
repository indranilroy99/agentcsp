...
assertEqual(vulnerable.manifest.findings.length, 523, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 523, "vulnerable findings.json count");
