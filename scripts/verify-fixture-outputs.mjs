...
assertEqual(vulnerable.manifest.findings.length, 486, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 486, "vulnerable findings.json count");
