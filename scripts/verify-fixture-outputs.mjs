...
assertEqual(vulnerable.manifest.findings.length, 1239, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1239, "vulnerable findings.json count");
