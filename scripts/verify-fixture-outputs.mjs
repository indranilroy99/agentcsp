...
assertEqual(vulnerable.manifest.findings.length, 110, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 110, "vulnerable findings.json count");
