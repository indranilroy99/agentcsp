...
assertEqual(vulnerable.manifest.findings.length, 1019, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 1019, "vulnerable findings.json count");
