...
assertEqual(vulnerable.manifest.findings.length, 189, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 189, "vulnerable findings.json count");
