...
assertEqual(vulnerable.manifest.findings.length, 320, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 320, "vulnerable findings.json count");
