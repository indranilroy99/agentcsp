...
assertEqual(vulnerable.manifest.findings.length, 656, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 656, "vulnerable findings.json count");
