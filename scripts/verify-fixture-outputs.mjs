...
assertEqual(vulnerable.manifest.findings.length, 179, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 179, "vulnerable findings.json count");
