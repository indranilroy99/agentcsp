...
assertEqual(vulnerable.manifest.findings.length, 527, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 527, "vulnerable findings.json count");
