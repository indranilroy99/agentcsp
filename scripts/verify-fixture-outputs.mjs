...
assertEqual(vulnerable.manifest.findings.length, 498, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 498, "vulnerable findings.json count");
