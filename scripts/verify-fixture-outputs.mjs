...
assertEqual(vulnerable.manifest.findings.length, 233, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 233, "vulnerable findings.json count");
