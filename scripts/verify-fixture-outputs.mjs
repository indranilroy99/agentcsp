...
assertEqual(vulnerable.manifest.findings.length, 165, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 165, "vulnerable findings.json count");
