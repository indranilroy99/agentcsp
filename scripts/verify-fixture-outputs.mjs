...
assertEqual(vulnerable.manifest.findings.length, 183, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 183, "vulnerable findings.json count");
