...
assertEqual(vulnerable.manifest.findings.length, 206, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 206, "vulnerable findings.json count");
