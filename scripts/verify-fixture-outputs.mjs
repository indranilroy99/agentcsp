...
assertEqual(vulnerable.manifest.findings.length, 195, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 195, "vulnerable findings.json count");
