...
assertEqual(vulnerable.manifest.findings.length, 620, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 620, "vulnerable findings.json count");
