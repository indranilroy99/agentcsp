...
assertEqual(vulnerable.manifest.findings.length, 499, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 499, "vulnerable findings.json count");
