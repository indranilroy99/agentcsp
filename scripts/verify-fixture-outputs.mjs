...
assertEqual(vulnerable.manifest.findings.length, 180, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 180, "vulnerable findings.json count");
