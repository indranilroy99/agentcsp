...
assertEqual(vulnerable.manifest.findings.length, 539, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 539, "vulnerable findings.json count");
