...
assertEqual(vulnerable.manifest.findings.length, 304, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 304, "vulnerable findings.json count");
