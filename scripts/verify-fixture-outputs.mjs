...
assertEqual(vulnerable.manifest.findings.length, 203, "vulnerable manifest finding count");
assertEqual(vulnerable.findings.length, 203, "vulnerable findings.json count");
