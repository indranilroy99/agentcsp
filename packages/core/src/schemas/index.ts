...
export const BaselineComparisonSchema = z.object({
  ...
  new_findings_by_risk_driver: z.array(TriageRiskDriverCountSchema).default([]),
...
export const StaticBlastRadiusSummarySchema = z.object({
  ...
  attack_path_limit: z.number().int().nonnegative().default(0),
  attack_paths_total: z.number().int().nonnegative().default(0),
  attack_paths_truncated: z.boolean().default(false),
